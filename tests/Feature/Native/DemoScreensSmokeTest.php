...
it('renders the demo screen without errors', function (string $uri) {
    ...
    'biteclub concept' => '/real-world/biteclub',
    'syncup concept' => '/real-world/syncup',
    'vibepass concept' => '/real-world/vibepass',
    'frame concept' => '/real-world/frame',
    'pulse concept' => '/real-world/pulse',
    'marketnest concept' => '/real-world/marketnest',
    'stayflow concept' => '/real-world/stayflow',
    'tunedeck concept' => '/real-world/tunedeck',
    'shoproom concept' => '/real-world/shoproom',
    'fieldkit concept' => '/real-world/fieldkit',
]);
